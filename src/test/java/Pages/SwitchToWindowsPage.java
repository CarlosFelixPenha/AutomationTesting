...
public void clicarOpcaoWindows () throws InterruptedException {
		WebElement opcaoWindows = driver.findElement (By.xpath("//*[@id=\"header\"]/nav/div/div[2]/ul/li[4]/ul/li[2]/a"));
		opcaoWindows.click();
		Thread.sleep(1000);
		}

public void clicarOpcaoMultileWindows () throws InterruptedException {
		WebElement opcaoMultipleWindows = driver.findElement (By.xpath("/html/body/div[1]/div/div/div/div[1]/ul/li[3]/a"));
		opcaoMultipleWindows.click();
		Thread.sleep(1000);
		}

public void clicarOpcaoSeparateWindows () throws InterruptedException {
	WebElement opcaoSeparateWindows = driver.findElement (By.xpath("/html/body/div[1]/div/div/div/div[1]/ul/li[2]/a"));
